...
<xsl:stylesheet version="1.0"
	...
	<xsl:param name="config-callback">upload_recipe</xsl:param>
	
	<!-- title of the generated document -->
	<xsl:param name="config-title">Recipe Update - Generated by XSD2HTML2XML v3</xsl:param>
	
	<!-- custom JavaScript file URL -->
	<xsl:param name="config-script">/scripts/github.js</xsl:param>
	<!-- <xsl:param name="config-script">/scripts/xsd2html2xml.js</xsl:param> -->
	
	<!-- custom CSS file URL -->
	<xsl:param name="config-style">/css/admin.css</xsl:param>
